...
Käyttöönotossa täytyy huomioida sekä tekniikka että ihmiset ja molempien yhteispeli. Lisäksi hallinto- ja päätöstentekotapa ovat tärkeässä roolissa. Jos osa-alueista joku jätetään huomiotta, niin se on omiaan aiheuttamaan muutosvastarintaa.
...
% TODO Mikseivät opettajat käytä enemmän tietotekniikkaa %\subsection{Yhteistyön lisääminen}
...
Jos oppilaat voidaan sitouttaa koulun sääntöihin kuten tupakointikieltoon miksei opettajiakin voitaisi sitouttaa yhteisiin tavoitteisiin? Opetuksen yhteistyötä saadaan myös lisättyä esimerkiksi aineiden yhteisillä tunneilla. Tietotekniikkaa voidaan hyödyntää maantiedon tunnilla tai liikuntaa yhdistää historiantuntiin. Tietysti myös esimerkiksi biologian ja fysiikan yhteäviä kohtia pystytään hyödyntämään.
%TODO lisää historiantuntiin. perään gps-softasta jotain
...
\subsection{Flipped classroom} %TODO avaa termiä ja käännä se.
%sido paremmin
...
%Muuta: Taulutietokoneet opetuksessa
...
1. Statistiikan hyödyntäminen. %kuinka paljon tilastoista saadaan irti, jenkit tilastoivat innokkaasti, miten tilastointia käytetään Suomessa?
