...
Jos oppilaat voidaan sitouttaa koulun sääntöihin, kuten tupakointikieltoon, miksei opettajiakin voitaisi sitouttaa yhteisiin tavoitteisiin? Opetuksen yhteistyötä saadaan myös lisättyä esimerkiksi aineiden yhteisillä tunneilla. Tietotekniikkaa voidaan hyödyntää maantiedon tunnilla, tai liikuntaa yhdistää historiantuntiin esimerkiksi GPS-pohjaisilla ratkaisuilla. \parencite[][]{heijoe} Tietysti myös esimerkiksi biologian ja fysiikan yhteneviä kohtia pystytään hyödyntämään. 
