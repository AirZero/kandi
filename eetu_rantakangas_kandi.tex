...
Jos oppilaat voidaan sitouttaa koulun sääntöihin kuten tupakointikieltoon miksei opettajiakin voitaisi sitouttaa yhteisiin tavoitteisiin? Opetuksen yhteistyötä saadaan myös lisättyä esimerkiksi aineiden yhteisillä tunneilla. Tietotekniikkaa voidaan hyödyntää maantiedon tunnilla tai liikuntaa yhdistää historiantuntiin. \parencite[][]{heijoe} Tietysti myös esimerkiksi biologian ja fysiikan yhteäviä kohtia pystytään hyödyntämään.
