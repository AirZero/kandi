...
Kouluissa käytettävien ohjelmistojen ei tarvitse olla yhtä motivoivia kuin oppilaiden vapaa-ajalla käyttämien. Samalla pystytään tuomaan oppimiseen enemmän painoa ja tehoa sisällöillä. Kotona vapaaehtoisesti pelattavat pelit ovat ensisijaisesti hauskoja. Kouluissa ne voivat olla ensisijaisesti myös opettavia.
